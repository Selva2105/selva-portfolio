export const PROJECTS = [
  ...
  },
  {
    ...
    tags: ['Event-Driven System', 'Nx Monorepo', 'NestJS + Next.js 14'],
    desc: 'A self-hosted, event-driven household operations platform designed to ingest messy real-world signals — renewing bills, expiring documents, home maintenance, and buried action items — and route timely alerts through WhatsApp and email. Architected as an Nx monorepo with modular NestJS services, BullMQ + Redis job queues, Prisma ORM on PostgreSQL, and a Next.js App Router dashboard.',
    short: 'Self-hosted household operations platform built with Next.js 14, NestJS, and BullMQ — normalizes messy signals like bills and expiring documents into automated WhatsApp bot and email alerts.',
    stats: [
      { n: 'Nx Monorepo', l: 'web, api, worker & bot' },
      { n: 'Event-Driven', l: 'BullMQ + Redis queues' },
      { n: 'Multi-Channel', l: 'WhatsApp + email alerts' },
    ],
  },
];
